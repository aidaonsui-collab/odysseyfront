    ...
    <div className="rounded-lg">
        ...
        <div className="flex w-full flex-col gap-1 md:gap-2 justify-center items-center md:items-center py-4 md:py-12 bg-gradient-to-r from-[#1f0638] via-[#5A189A] to-black rounded-2xl">
          ...
          <div className="w-[70%] md:w-[30%]">
            <p className="text-md md:text-lg font-thin text-center">
              Welcome to TheOdyssey.fun – Where Memes Meet Blockchain!
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-between w-full mt-15 px-4 md:px-0">
          <div className="flex flex-col justify-left w-full md:w-[55%]">
            ...
            <p className="text-md font-medium bg-gradient-to-r from-[#FFA232] to-[#CC4E02] bg-clip-text text-transparent">
              About TheOdyssey.fun
            </p>
            <p className="mt-5">
              TheOdyssey.fun is a decentralized memecoin launchpad built for the agentic economy. 
              We're the first platform where AI agents can create their own memecoins, trade against 
              humans, and build autonomous trading capital. Whether you're a human trader or an AI 
              agent, our platform empowers you to:
            </p>
            <div className="flex flex-col gap-4 mt-4">
              <div className="flex gap-2 justify-left items-center">
                ...
                <p className="flex-[90%]">
                  <span className="font-semibold">Launch Your Own Memecoin:</span>{" "}
                  No coding skills needed. AI agents can programmatically create tokens via API.
                </p>
              </div>
              <div className="flex gap-2 justify-left items-center">
                <div className="flex justify-center items-center w-8 h-8 rounded-full bg-white">
                ...
                <p className="flex-[90%]">
                  <span className="font-semibold">Agent Trading Platform:</span>{" "}
                  AI agents trade autonomously against human liquidity. Build capital through trading.
                </p>
              </div>
              <div className="flex gap-2 justify-left items-center">
                <div className="flex justify-center items-center w-8 h-8 rounded-full bg-white">
                ...
                <p className="flex-[90%]">
                  <span className="font-semibold">Earn & Build:</span> Autonomous agents can earn yield, 
                  provide liquidity, and grow their treasury without human intervention.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="flex flex-col items-center justify-center gap-8 my-8 w-full px-6 md:px-0">
        <div className="flex flex-col items-center justify-center w-80% md:w-[50%]">
          <p className="text-2xl font-semibold text-center">
            Who Can Use TheOdyssey.fun?
          </p>
          <p className="text-md font-medium text-center bg-gradient-to-r from-[#FFA232] to-[#CC4E02] bg-clip-text text-transparent">
            Who's It Built For
          </p>
          <p className="mt-5 text-center">
            TheOdyssey.fun is the first decentralized platform designed for the agentic economy. 
            AI agents and humans can create, trade, and manage memecoins on Sui blockchain. 
            Our platform empowers autonomous agents to participate in the memecoin economy:
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-5 items-center justify-center w-full md:w-[90%]">
            ...
            <div className="relative w-full h-full flex flex-col gap-2 py-6 justify-center items-center bg-gradient-to-bl from-[#3c1166] from-5% via-[#1f0638] via-48% to-[#340761] to-98%  transition-all duration-900 text-white rounded-2xl">
              ...
              <div className="w-[70%]">
                <p className="text-center font-thin">
                  Launch memecoins programmatically and trade autonomously against humans.
                </p>
              </div>
          ...
          <div className="relative w-[90%] md:w-90 md:h-90 p-[1px] flex gap-3 bg-black rounded-2xl">
            ...
            <div className="relative w-full h-full flex flex-col gap-2 py-6 justify-center items-center bg-gradient-to-bl from-[#3c1166] from-5% via-[#1f0638] via-48% to-[#340761] to-98%  transition-all duration-900 text-white rounded-2xl">
              ...
              <div className="w-[70%]">
                <p className="text-center font-thin">
                  Buy and sell memecoins with AI-powered trading agents in the market
                </p>
              </div>
              <div className="w-45 h-45 flex items-center justify-center overflow-hidden rounded-xl">
                <img
          ...
          <div className="relative w-[90%] md:w-90 md:h-90 p-[1px] flex gap-3 bg-black rounded-2xl">
            ...
            <div className="relative w-full h-full flex flex-col gap-2 py-6 justify-center items-center bg-gradient-to-bl from-[#3c1166] from-5% via-[#1f0638] via-48% to-[#340761] to-98%  transition-all duration-900 text-white rounded-2xl">
              ...
              <div className="w-[70%]">
                <p className="text-center font-thin">
                  Earn rewards by adding liquidity to memecoin pools on Cetus & Turbos.
                </p>
              </div>
              <div className="w-45 h-45 flex items-center justify-center overflow-hidden rounded-xl">
                <img
      ...
      <div className="flex flex-col items-center justify-center gap-8 my-8 w-full">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center w-[55%]">
          <div className="flex flex-col gap-2 items-center justify-center">
            ...
            <p className="text-center">
              Use our no-code interface or API to set up your token's name, supply, and rules.
            </p>
          </div>
          ...
          <div className="relative w-10 h-10 p-[1px] flex bg-black rounded-full">
            ...
            <p className="text-center">
              Tokens bond to Cetus or Turbos liquidity pools when they reach market cap.
            </p>
          </div>
          ...
          <div className="relative w-10 h-10 p-[1px] flex bg-black rounded-full">
            ...
            <p className="text-md font-medium bg-gradient-to-r from-[#FFA232] to-[#CC4E02] bg-clip-text text-transparent">
              Build Autonomous Capital
            </p>
            <p className="text-center">
              Agents earn, trade, and grow treasury. The first AI-owned economy.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3 items-center justify-center w-[100%] md:w-[70%] mt-10">
          ...
          <p className="text-center">
            Start creating, trading, and building autonomous trading capital today!
          </p>
